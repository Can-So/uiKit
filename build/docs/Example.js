...
function (_React$Component) {
  ...
  function Example() {
    ...
    _defineProperty(_assertThisInitialized(_this), "toggleSource", function () {
      _this.setState({
        isSourceVisible: !_this.state.isSourceVisible
      });
    });

    _defineProperty(_assertThisInitialized(_this), "onError", function (error, info) {
      console.error(error);
      console.error(info);
    });
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      ...
      return React.createElement(Wrapper, {
        ...
        mode: mode
      }, title), React.createElement(ToggleIcon, {
        label: toggleLabel
      })), isSourceVisible ? React.createElement(CodeWrapper, null, React.createElement(AkCodeBlock, {
        text: packageName ? replaceSrc(source, packageName) : source,
        language: language,
        showLineNumbers: false
      })) : null, React.createElement(Showcase, null, React.createElement(ErrorBoundary, {
...
}, toggleColor, gridSize, gridSize, TRANSITION_DURATION);
export var Toggle = styled.div.withConfig({
  displayName: "Example__Toggle",
  componentId: "sc-1v4pqfw-1"
})(["\n  align-items: center;\n  cursor: pointer;\n  display: flex;\n  justify-content: space-between;\n  padding: ", "px;\n  transition: color ", ", fill ", ";\n"], gridSize, TRANSITION_DURATION, TRANSITION_DURATION); // NOTE: use of important necessary to override element targeted headings
