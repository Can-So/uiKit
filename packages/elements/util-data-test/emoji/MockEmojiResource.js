...
export { MockNonUploadingEmojiResource };
...
export { UsageClearEmojiResource };
export var mockNonUploadingEmojiResourceFactory = function (emojiRepository, config, promiseBuilder) {
...
export var mockEmojiResourceFactory = function (emojiRepository, config, promiseBuilder) {
