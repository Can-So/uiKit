...
type Props = PopupUserPickerProps & WithAnalyticsEventProps;
...
class UserPickerInternal extends React.Component<Props, UserPickerState> {
  ...
  static getDerivedStateFromProps(
    ...
    if (nextProps.open !== prevState.menuIsOpen) {
      derivedState.preventFilter = true;
    }
    ...
    if (
      ...
      derivedState.preventFilter = false;
    }
  ...
  render() {
    ...
    const isModal = !!this.props.target;

    // return <UserPicker {...this.props} open />
    ...
    return (
      <PopupSelect
        ...
        {...getModalProps(isModal)}
      />
    );
  }
}

export const PopupUserPicker: React.ComponentClass<
  UserPickerProps
