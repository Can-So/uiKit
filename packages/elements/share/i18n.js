...
export var messages = defineMessages({
    ...
    userPickerAddMoreMessage: {
        ...
        description: 'Message to encourage the user to add more items to user picker in Share form.',
    },
    ...
    shareFailureMessage: {
        ...
        description: 'Default text for share failure message displayed in the tooltip',
    },
});
