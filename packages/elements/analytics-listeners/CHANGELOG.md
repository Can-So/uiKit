...
## 4.1.3
- [patch] [dff4f0e](https://github.com/fnamazing/uiKit/commits/dff4f0e):

  - AnalyticsListeners should accept any promise-like client

## 4.1.2
- [patch] [e981882](https://github.com/fnamazing/uiKit/commits/e981882):
...
## 4.1.0
- [minor] [dd0a73c](https://github.com/fnamazing/uiKit/commits/dd0a73c):

  - Allow consumers to pass promise of analytics web client as well as the client itself

## 4.0.7
- [patch] [1d30f7e](https://github.com/fnamazing/uiKit/commits/1d30f7e):

  - Make analytics-web-client non-mandatory

## 4.0.6
- [patch] [c525423"
d](https://github.com/fnamazing/uiKit/commits/c525423"
d):
...
## 4.0.4
- [patch] FS-3057 pick fields from context [187d175](https://github.com/fnamazing/uiKit/commits/187d175)
...
## 4.0.0
- [patch] fixed async tests and removed redundant componenthelpers [3599b88](https://github.com/fnamazing/uiKit/commits/3599b88)
- [patch] Fixed async test expectations [b8c167d](https://github.com/fnamazing/uiKit/commits/b8c167d)
- [major] removed promise from FabricAnalyticsListener.client property [90ba6bd](https://github.com/fnamazing/uiKit/commits/90ba6bd)

## 3.4.1
- [patch] Fix elements listener listening on wrong channel [2b817e1](https://github.com/fnamazing/uiKit/commits/2b817e1)

## 3.4.0
- [minor] Support the screen event type for navigation events [20b8844](https://github.com/fnamazing/uiKit/commits/20b8844)

- [none] Updated dependencies [20b8844](https://github.com/fnamazing/uiKit/commits/20b8844)
- [patch] Updated dependencies [85ddb9e](https://github.com/fnamazing/uiKit/commits/85ddb9e)
  - @findable/analytics-gas-types@3.2.0

## 3.3.1
- [patch] Add next gen analytics to conversation component [dfa100e](https://github.com/fnamazing/uiKit/commits/dfa100e)
...
## 3.3.0
- [minor] Update navigation listener to process operational events [2d53fc1](https://github.com/fnamazing/uiKit/commits/2d53fc1)
- [none] Updated dependencies [2d53fc1](https://github.com/fnamazing/uiKit/commits/2d53fc1)

## 3.2.0
- [minor] Update navigation listener to process NavigationAnalyticsContext [808b55b](https://github.com/fnamazing/uiKit/commits/808b55b)

- [none] Updated dependencies [808b55b](https://github.com/fnamazing/uiKit/commits/808b55b)
  - @findable/analytics-namespaced-context@2.1.0
- [patch] Updated dependencies [89225ce](https://github.com/fnamazing/uiKit/commits/89225ce)
  - @findable/analytics-namespaced-context@2.1.0
...
- [none] Updated dependencies [3f0cd7d](https://github.com/fnamazing/uiKit/commits/3f0cd7d)
  - @findable/analytics-namespaced-context@2.0.3
  - @findable/analytics-gas-types@3.1.3

## 3.1.0
- [minor] Add navigation listener that listens to events fired from within the new @findable/navigation-next and @findable/global-navigation packages. [fb67997](https://github.com/fnamazing/uiKit/commits/fb67997)
- [minor] Add excludedChannels prop to exclude listeners on certain channels from being rendered. This is primarily intended to prevent the events fired on the atlaskit channel from being captured so that duplicate events are not sent for atlaskit/core components. [d43b8a2](https://github.com/fnamazing/uiKit/commits/d43b8a2)

## 3.0.3
- [patch] Updated dependencies [acd86a1](https://github.com/fnamazing/uiKit/commits/acd86a1)
  - @findable/button@9.0.4
  - @findable/analytics-namespaced-context@2.0.2
  - @findable/analytics-next@3.0.3
  - @findable/docs@5.0.2
  - @findable/analytics-gas-types@3.1.2

## 3.0.2
- [patch] Updated dependencies [80e90ed](https://github.com/fnamazing/uiKit/commits/80e90ed)
  - @findable/analytics-namespaced-context@2.0.1

## 3.0.1
- [patch] fixes problem caused by source not always being set [00b1a71](https://github.com/fnamazing/uiKit/commits/00b1a71)
...
- [major] Updated dependencies [563a7eb](https://github.com/fnamazing/uiKit/commits/563a7eb)
  ...
  - @findable/analytics-namespaced-context@2.0.0
...
- [none] Updated dependencies [f1a9069](https://github.com/fnamazing/uiKit/commits/f1a9069)
  - @findable/analytics-namespaced-context@1.0.3
...
- [none] Updated dependencies [9c32280](https://github.com/fnamazing/uiKit/commits/9c32280)
  - @findable/analytics-namespaced-context@1.0.2
...
- [none] Updated dependencies [53cba6b](https://github.com/fnamazing/uiKit/commits/53cba6b)
  - @findable/analytics-next@2.1.9

## 2.1.0
- [patch] merge analytics-next context into GAS payload attributes in FabricElementsListener [5d25e8b](https://github.com/fnamazing/uiKit/commits/5d25e8b)
- [minor] moved Atlaskit tests from src to __tests__ [1f78c33](https://github.com/fnamazing/uiKit/commits/1f78c33)
...
## 2.0.0
- [major] client parameter changed to a Promise in the listeners given Confluence gets the AnalyticsWebClient instance asynchronously [628e427](https://github.com/fnamazing/uiKit/commits/628e427)

## 1.2.0
- [patch] Throw error on component construction when client prop is missing rather than silently failing until an event is fired [4bbce97](https://github.com/fnamazing/uiKit/commits/4bbce97)
- [minor] Add some debug/error logging to listener which can be enabled via the logLevel prop [191a1ff](https://github.com/fnamazing/uiKit/commits/191a1ff)
...
## 1.1.0
- [minor] Add listener for events fired by core atlaskit components [bcc7d8f](https://github.com/fnamazing/uiKit/commits/bcc7d8f)
- [patch] Updated dependencies [9be1db0](https://github.com/fnamazing/uiKit/commits/9be1db0)
  - @findable/analytics-gas-types@2.1.0

## 1.0.2
- [patch] Moved event tag to FabricElementsListener [639ae5e](https://github.com/fnamazing/uiKit/commits/639ae5e)

## 1.0.1
- [patch] code improvements [44e55aa](https://github.com/fnamazing/uiKit/commits/44e55aa)
- [patch] added analytics-listeners package  [8e71e9a](https://github.com/fnamazing/uiKit/commits/8e71e9a)
