...
export default {
    ...
    'global_search.confluence.confluence_objects_heading': 'Sidor, bloggar och bilagor',
    'global_search.confluence.advanced_search': 'Avancerad sökning',
    'global_search.confluence.advanced_search_filters': 'Avancerad sökning med filter',
    'global_search.confluence.advanced_search_for': 'Avancerad sökning efter "{query}"',
    'global_search.no_recent_activity_title': 'Sök efter vad du behöver',
    'global_search.no_recent_activity_body': 'Eller använd <a href={url}>Avancerad sökning</a> (skift + retur) för att söka mer fokuserat.',
    'global_search.no_results_title': 'Inga resultat i titlar och personer',
    'global_search.no_results_body': 'Försök igen med ett annat sökord eller förfina ditt resultat med avancerad sökning.',
    ...
    'global_search.search_error_body': 'Det kan vara ett tillfälligt problem. Bäst är att {link}.',
    ...
    'global_search.jira.recent_containers': 'Senaste anslagstavlor, filter och projekt',
    'global_search.jira.search_result_issues_heading': 'Ärenden',
    'global_search.jira.search_result_containers_heading': 'Anslagstavlor, filter och projekt',
    ...
    'global_search.jira.no_results_title': 'Vi hittade inget som matchade din sökning',
    'global_search.jira.no_results_body': 'Försök igen med ett annat sökord eller förfina ditt resultat med avancerad sökning.',
    'global_search.jira.no_recent_activity_body': 'Eller förfina ditt resultat med avancerad sökning.',
