...
export var messages = defineMessages({
    ...
    no_recent_activity_body: {
        ...
        defaultMessage: 'Or use <a href={url}>advanced search</a> (`shift + enter`) to focus your results.',
        description: '',
    },
    no_results_title: {
    ...
    no_results_body: {
        ...
        defaultMessage: 'Try again with a different term, or refine your results with our advanced search.',
        description: '',
    },
