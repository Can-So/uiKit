...
import FileTypes24File24ImageIcon from '@findable/icon-file-type/glyph/image/24';
import FileTypes24File24ExcelSpreadsheetIcon from '@findable/icon-file-type/glyph/excel-spreadsheet/24';
import FileTypes24File24VideoIcon from '@findable/icon-file-type/glyph/video/24';
import FileTypes24File24ArchiveIcon from '@findable/icon-file-type/glyph/archive/24';
import FileTypes24File24PowerpointPresentationIcon from '@findable/icon-file-type/glyph/powerpoint-presentation/24';
import FileTypes24File24SourceCodeIcon from '@findable/icon-file-type/glyph/source-code/24';
import FileTypes24File24AudioIcon from '@findable/icon-file-type/glyph/audio/24';
import FileTypes24File24WordDocumentIcon from '@findable/icon-file-type/glyph/word-document/24';
import FileTypes24File24PdfDocumentIcon from '@findable/icon-file-type/glyph/pdf-document/24';
import FileTypes24File24GenericIcon from '@findable/icon-file-type/glyph/generic/24';
