...
export default {
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.admin': 'Esses produtos já não são faturados.',
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.self': 'Esses produtos já não são faturados.',
    'focused-task-close-account.delete-account.content-preview.heading': 'Como será apresentada esta conta aos utilizadores',
