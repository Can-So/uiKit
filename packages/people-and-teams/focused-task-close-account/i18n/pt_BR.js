...
export default {
    ...
    'focused-task-close-account.delete-account.overview.inline-dialog.data-apps.admin': 'Você ou outros usuários podem ter instalado aplicativos que adicionam recursos aos produtos da Atlassian. Esses aplicativos podem ter armazenado as informações de perfil do usuário.',
    'focused-task-close-account.delete-account.overview.inline-dialog.data-apps.self': 'Você ou outros usuários podem ter instalado aplicativos que adicionam recursos aos produtos da Atlassian. Esses aplicativos podem ter armazenado suas informações de perfil.',
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.about-to-deactivate.admin': 'Quando você desativa a conta:',
    'focused-task-close-account.deactivate-account.overview.paragraph.about-to-deactivate.self': 'Quando você desativa a conta:',
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.personal-data.admin': 'Seus dados pessoais, como nome completo e endereço de e-mail, e o conteúdo criado permanecerá nos serviços de conta da Atlassian.',
    'focused-task-close-account.deactivate-account.overview.paragraph.personal-data.self': 'Seus dados pessoais, como nome completo e endereço de e-mail, e o conteúdo criado permanecerá nos serviços de conta da Atlassian.',
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.admin': 'Não vamos mais cobrar você por isso.',
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.self': 'Não vamos mais cobrar você por isso.',
    'focused-task-close-account.delete-account.content-preview.heading': 'Como os usuários verão esta conta',
