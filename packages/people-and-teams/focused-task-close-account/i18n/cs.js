...
export default {
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.personal-data.admin': 'Osobní údaje uživatelů, jako je celé jméno a e-mailová adresa, a obsah, který vytvořili, ve službách účtu účet Atlassian zůstane.',
    'focused-task-close-account.deactivate-account.overview.paragraph.personal-data.self': 'Osobní údaje uživatelů, jako je celé jméno a e-mailová adresa, a obsah, který vytvořili, ve službách účtu účet Atlassian zůstane.',
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.admin': 'Už vám je nebudeme fakturovat.',
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.self': 'Už vám je nebudeme fakturovat.',
    'focused-task-close-account.delete-account.content-preview.heading': 'Jak uživatelé uvidí tento účet',
