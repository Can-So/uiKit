...
export default {
    ...
    'focused-task-close-account.delete-account.overview.paragraph.loseAccess.admin': "{fullName} <b>perdra immédiatement l'accès</b> à tous les services de compte Atlassian. Il a actuellement accès à :",
    ...
    'focused-task-close-account.delete-account.overview.paragraph.loseAccess.admin.noSites': "{fullName} <b>perdra immédiatement l'accès</b> à tous les services de compte Atlassian. Il n'a pour le moment accès à aucun service, sauf Community et Marketplace.",
    'focused-task-close-account.delete-account.overview.paragraph.loseAccess.self.noSites': "Vous <b>perdrez immédiatement l'accès</b> à tous les services de compte Atlassian. Vous n'avez pour le moment accès à aucun service, sauf Community et Marketplace.",
    ...
    'focused-task-close-account.delete-account.overview.paragraph.content-created.admin': "Le contenu qu'ils ont créé sera toujours disponible dans les services de compte Atlassian.",
    ...
    'focused-task-close-account.delete-account.overview.inline-dialog.content-created.admin': "Par exemple, les pages, les tickets et les commentaires qu'ils ont créés dans les produits.",
    ...
    'focused-task-close-account.delete-account.overview.paragraph.personal-data-will-be-deleted.admin': 'Leurs <b>données personnelles</b>, comme leur nom complet et leur adresse e-mail, seront supprimées des services de compte Atlassian dans les 30 jours, sauf dans de rares cas lorsque des raisons juridiques ou commerciales légitimes le requièrent.',
    ...
    'focused-task-close-account.delete-account.overview.paragraph.list-of-apps-with-personal-data.admin': 'Nous vous enverrons par e-mail une liste des applications qui ont pu conserver leurs données personnelles.',
    ...
    'focused-task-close-account.delete-account.overview.inline-dialog.personal-data-will-be-deleted.li1.admin': "Informations relatives aux achats que nous devons conservées pour l'établissement des rapports financiers.",
    'focused-task-close-account.delete-account.overview.inline-dialog.personal-data-will-be-deleted.li1.self': "Informations relatives aux achats que nous devons conservées pour l'établissement des rapports financiers.",
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.loseAccess.admin': "{fullName} <b>perdra immédiatement l'accès</b> à tous les services de compte Atlassian. Il a actuellement accès à :",
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.loseAccess.admin.noSites': "{fullName} <b>perdra immédiatement l'accès</b> à tous les services de compte Atlassian. Il n'a pour le moment accès à aucun service, sauf Community et Marketplace.",
    'focused-task-close-account.deactivate-account.overview.paragraph.loseAccess.self.noSites': "Vous <b>perdrez immédiatement l'accès</b> à tous les services de compte Atlassian. Vous n'avez pour le moment accès à aucun service, sauf Community et Marketplace.",
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.personal-data.admin': "Les données personnelles, comme le nom complet et l'adresse e-mail, ainsi que le contenu créés seront toujours disponibles dans les services de compte Atlassian.",
    'focused-task-close-account.deactivate-account.overview.paragraph.personal-data.self': "Les données personnelles, comme le nom complet et l'adresse e-mail, ainsi que le contenu créés seront toujours disponibles dans les services de compte Atlassian.",
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.admin': 'Ils ne vous seront plus facturés.',
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.self': 'Ils ne vous seront plus facturés.',
    'focused-task-close-account.delete-account.content-preview.heading': 'Comment les utilisateurs verront ce compte',
