...
export default {
    ...
    'focused-task-close-account.delete-account.overview.inline-dialog.personal-data-will-be-deleted.p2.admin': 'No eliminamos ningún dato personal del contenido creado por los usuarios, como nombres o direcciones de correo electrónico escritas en una página o incidencia. Los administradores del producto son quienes deben eliminar esos datos manualmente.',
    'focused-task-close-account.delete-account.overview.inline-dialog.personal-data-will-be-deleted.p2.self': 'No eliminamos ningún dato personal del contenido que creas tú o crean otras personas, como nombres o direcciones de correo electrónico escritas en una página o incidencia. Los administradores de tu producto son quienes deben eliminar esos datos manualmente.',
    ...
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.admin': 'Dejaremos de facturarte por estos usuarios.',
    'focused-task-close-account.deactivate-account.overview.paragraph.billing.self': 'Dejaremos de facturarte por estos usuarios.',
    'focused-task-close-account.delete-account.content-preview.heading': 'Cómo verán los usuarios esta cuenta',
