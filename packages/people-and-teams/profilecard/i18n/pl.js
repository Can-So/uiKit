...
export default {
  ...
  'pt.profile-card.inactive.account.has.date.several.months': 'Jej konto zostało zdezaktywowane przynajmniej kilka miesięcy temu.',
  ...
  'pt.profile-card.closed.account.has.date.this.week': 'Jej konto usunięte w tym tygodniu.',
  ...
  'pt.profile-card.closed.account.has.date.a.few.months': 'Jej konto zostało zdezaktywowane przynajmniej kilka miesięcy temu.',
  'pt.profile-card.closed.account.has.date.several.months': 'Jej konto zostało usunięte przynajmniej kilka miesięcy temu.',
