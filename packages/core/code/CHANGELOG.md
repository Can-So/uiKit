...
## 8.2.3
- [patch] [d49e9bbb13](https://github.com/fnamazing/uiKit/commits/d49e9bbb13):
...
## 8.2.0
- [minor] [10fe416](https://github.com/fnamazing/uiKit/commits/10fe416):
...
## 8.1.0
- [minor] [26027dd](https://github.com/fnamazing/uiKit/commits/26027dd):
...
## 8.0.10
- [patch] Update babel config to transpile out dynamic imports for commonjs [2dae295](https://github.com/fnamazing/uiKit/commits/2dae295)

## 8.0.9
- [patch] Adds missing implicit @babel/runtime dependency [b71751b](https://github.com/fnamazing/uiKit/commits/b71751b)

## 8.0.8
- [patch] Add some padding to the code without line numbers [67cd63d](https://github.com/fnamazing/uiKit/commits/67cd63d)

## 8.0.7
- [patch] Added yaml to supported languages for code and added styling for the key token. [95f9236](https://github.com/fnamazing/uiKit/commits/95f9236)
...
## 8.0.0
- [major] ED-4989: replace hjs with prism [f9c0cdb](https://github.com/fnamazing/uiKit/commits/f9c0cdb)
- [none] Updated dependencies [f9c0cdb](https://github.com/fnamazing/uiKit/commits/f9c0cdb)
  - @findable/docs@5.0.5
...
## 6.0.1
- [patch] Add default theme prop to prevent Code throwing errors when no theme provider is given [07334bc](https://github.com/fnamazing/uiKit/commits/07334bc)
- [none] Updated dependencies [07334bc](https://github.com/fnamazing/uiKit/commits/07334bc)

## 6.0.0
- [major] Significantly reduce the bundle-size of @findable/code by only supporting a subset of languages. Also introduces support for theming the content via @findable/theme. AK-4536 [eee2d45](https://github.com/fnamazing/uiKit/commits/eee2d45)
- [none] Updated dependencies [eee2d45](https://github.com/fnamazing/uiKit/commits/eee2d45)
  - @findable/docs@4.2.1
...
## 4.0.1
- [patch] Get rid of outdent dependency [6a2c1d9](https://github.com/fnamazing/uiKit/commits/6a2c1d9)

## 4.0.0
- [major] Bump to React 16.3. [4251858](https://github.com/fnamazing/uiKit/commits/4251858)

## 3.1.2
- [patch] Plain text should not be rendered as markdown [fe307dc](https://github.com/fnamazing/uiKit/commits/fe307dc)
...
## 3.0.0
- [major] Moved to elements repo converted to flow typing, stripped out typescript types [235e392](https://github.com/fnamazing/uiKit/commits/235e392)

## 2.2.1
- [patch] Remove styled-components as a peerDependency from @findable/code. [047032b](https://github.com/fnamazing/uiKit/commits/047032b)
