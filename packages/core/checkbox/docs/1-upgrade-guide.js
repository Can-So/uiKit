...
export default md`
  @findable/checkbox 5.x is part of an ongoing body of work to normalise atlaskit form components.
  There are a few breaking changes you need to be aware of in upgrading from 4.x to 5.x.

  ## Exports
  @findable/checkbox no longer specifies the Checkbox component as the default export.
  Moreover the following changes have been made to exports from the @findable/checkbox package.

  ### Checkbox:
  Checkbox is now a **named** export of the @findable/checkbox package. Please import it as below.

  ${code`import { Checkbox } from @findable/checkbox;`}
  ...
  ${(
    <SectionMessage title="Deprecated Component" appearance="error">
      {`
        @findable/checkbox no longer exports a CheckboxGroup component. It has been removed for the following reasons:
  ...
  ${code`import { CheckboxIcon } from @findable/checkbox;`}

  @findable/checkbox now also exports a CheckboxIcon component, this is a functional wrapper around the @findable/icon/glyph/checkbox svg,
  ...
  See the CheckboxSelect in @findable/select for an example use case.
