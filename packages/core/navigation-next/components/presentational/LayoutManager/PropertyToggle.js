...
function (_PureComponent) {
  ...
  function PropertyToggle() {
    ...
    _defineProperty(_assertThisInitialized(_this), "originalAttributes", {});

    _defineProperty(_assertThisInitialized(_this), "originalStyles", {});

    _defineProperty(_assertThisInitialized(_this), "attributeKeys", void 0);

    _defineProperty(_assertThisInitialized(_this), "styleKeys", void 0);
