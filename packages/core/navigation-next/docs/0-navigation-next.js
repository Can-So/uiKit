...
#### 📦 [UI components](/packages/core/navigation-next/docs/ui-components)

Props documentation for all of the components exported by \`navigation-next\`.

#### 🧠 [State controllers](/packages/core/navigation-next/docs/state-controllers)

API reference for the UI and View state containers.

## Guides

#### 🗺 [Composing your navigation](/packages/core/navigation-next/docs/composing-your-navigation)
...
#### 🌏 [Controlling navigation views](/packages/core/navigation-next/docs/controlling-navigation-views)
...
#### 🍰 [Code Splitting & Component Entrypoints](/packages/core/navigation-next/docs/code-splitting-and-component-entrypoints)
...
#### 🛠 [Upgrade guide](/packages/core/navigation-next/docs/upgrade-guide)
