...
## 9.0.0
- [major] [1a09599](https://github.com/fnamazing/uiKit/commits/1a09599):

  New features in this release of @findable/pagination
...
## 8.0.5
- [patch] Fix for pagination in IE [bd9046e](https://github.com/fnamazing/uiKit/commits/bd9046e)
...
## 8.0.2
- [patch] Fix styling in IE and maintain it in other browsers [0d67e69](https://github.com/fnamazing/uiKit/commits/0d67e69)

## 8.0.1
- [patch] Bump to add icon [8010540](https://github.com/fnamazing/uiKit/commits/8010540)

## 8.0.0
- [major] updated the pagination component as per ADG spec [8276156](https://github.com/fnamazing/uiKit/commits/8276156)
...
## 6.0.2
- [patch] moved atlaskit from dependencies to dev dependency [5e14f44](https://github.com/fnamazing/uiKit/commits/5e14f44)
...
## 4.0.0
- [major] Combines stateless and stateful components into one. Deletes stateless export. Renames pagination props. [a4b6c86](https://github.com/fnamazing/uiKit/commits/a4b6c86)
...
## 3.5.8
- [patch] Bumping dependency on docs [a2462c4](https://github.com/fnamazing/uiKit/commits/a2462c4)
- [patch] Update pagination number proptypes to be more permissive [e7cca21](https://github.com/fnamazing/uiKit/commits/e7cca21)
