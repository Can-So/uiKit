...
## 7.0.3
- [patch] Inline-message now closes on outside click correctly. [988b80a](https://github.com/fnamazing/uiKit/commits/988b80a)
...
## 7.0.0
- [major] Inline-message "position" prop has been changed to "placement" to align with what is in @findable/inline-dialog and react-popper [333a440](https://github.com/fnamazing/uiKit/commits/333a440)
...
## 3.2.1
- [patch] added truncating logic for text in inline message [0b59d44](https://github.com/fnamazing/uiKit/commits/0b59d44)
...
## 3.0.6
- [patch] updated icons for error, info and udpated size of icon for confirmation [824c40d](https://github.com/fnamazing/uiKit/commits/824c40d)

## 3.0.5
- [patch] migrate inline-message from ak to mk-2 [2323022](https://github.com/fnamazing/uiKit/commits/2323022)
