...
import Calendar from '@findable/icon/glyph/calendar';
import Page from '@findable/icon/glyph/page';
import Question from '@findable/icon/glyph/question';
import Expand from '@findable/icon/glyph/arrow-down';
import Unlink from '@findable/icon/glyph/editor/unlink';
import Open from '@findable/icon/glyph/editor/open';
