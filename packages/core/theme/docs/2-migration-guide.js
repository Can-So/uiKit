...
export default md`
## Migrate from @findable/util-shared-styles

### Reasons to migrate

1. The @findable/util-shared-styles package is now unmaintained and will not represent the ADG styles.
2. Feature requests are not accepted for @findable/util-shared-styles anymore.
3. The @findable/theme package is the source of truth for ADG styling.
...
Please see [codemod-util-shared-styles-to-theme](https://github.com/fnamazing/uiKit/src/master/packages/bitbucket/codemod-util-shared-styles-to-theme/)
and go through readme for details.

### Migrating the less styles

With the existing tooling we cannot consume the @findable/theme package in less files. Therefore, building
...
${code`
// styles.less
@import '../node_modules/@findable/util-shared-styles/src/grid.less';
...
***( This is just the structure, please see [css-reset/js-to-css.js](https://github.com/fnamazing/uiKit/src/master/packages/css-packs/css-reset/build/js-to-css.js)
