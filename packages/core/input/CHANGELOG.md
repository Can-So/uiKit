...
## 1.6.4
- [patch] Fixed font-size in Input component [bebf0ab](https://github.com/fnamazing/uiKit/commits/bebf0ab)

## 1.6.3
- [patch] Minor documentation fixes [f0e96bd](https://github.com/fnamazing/uiKit/commits/f0e96bd)

## 1.6.2
- [patch] Move input to new repository [0d7c5fd](https://github.com/fnamazing/uiKit/commits/0d7c5fd)
