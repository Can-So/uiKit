...
## 6.1.0
- [minor] [925de1a](https://github.com/fnamazing/uiKit/commits/925de1a):
...
## 4.1.0
- [minor] Add linkComponent to allow passing of custom link components [d2d2678](https://github.com/fnamazing/uiKit/commits/d2d2678)
...
## 3.0.12
- [patch] Fixed flow error [c3d78ba](https://github.com/fnamazing/uiKit/commits/c3d78ba)

## 3.0.10
- [patch] Fix references to link and linkHover (in theme)  from the Tag styles components [d509c86](https://github.com/fnamazing/uiKit/commits/d509c86)
