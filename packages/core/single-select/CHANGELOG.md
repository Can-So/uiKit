...
## 4.0.2
- [patch] Export types for Single select [dd51dad](https://github.com/fnamazing/uiKit/commits/dd51dad)
- [none] Updated dependencies [dd51dad](https://github.com/fnamazing/uiKit/commits/dd51dad)
...
## 3.2.2
- [patch] Fixes dependency on @findable/webdriver-runner to be a devDependency [4567857](https://github.com/fnamazing/uiKit/commits/4567857)
...
## 3.1.4
- [patch] Remove index.js from root, fix flow type, remove react from dep [4f1e6d1](https://github.com/fnamazing/uiKit/commits/4f1e6d1)

## 3.1.3
- [patch] Migrate signle-select to atlaskit-mk-2 repo [ee8d580](https://github.com/fnamazing/uiKit/commits/ee8d580)
