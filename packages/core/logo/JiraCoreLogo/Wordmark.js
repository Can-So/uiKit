...
function (_Component) {
  ...
  function JiraCoreWordmark() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(JiraCoreWordmark).apply(this, arguments));
  }
...
_defineProperty(JiraCoreWordmark, "defaultProps", DefaultProps);

export { JiraCoreWordmark as default };