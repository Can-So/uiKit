...
function (_Component) {
  ...
  function JiraCoreLogo() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(JiraCoreLogo).apply(this, arguments));
  }
...
_defineProperty(JiraCoreLogo, "defaultProps", DefaultProps);

export { JiraCoreLogo as default };