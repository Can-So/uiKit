...
function (_Component) {
  ...
  function BitbucketWordmark() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BitbucketWordmark).apply(this, arguments));
  }
...
_defineProperty(BitbucketWordmark, "defaultProps", DefaultProps);

export { BitbucketWordmark as default };