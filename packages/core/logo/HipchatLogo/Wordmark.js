...
function (_Component) {
  ...
  function HipchatWordmark() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(HipchatWordmark).apply(this, arguments));
  }
...
_defineProperty(HipchatWordmark, "defaultProps", DefaultProps);

export { HipchatWordmark as default };