...
function (_Component) {
  ...
  function ConfluenceIcon() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ConfluenceIcon).apply(this, arguments));
  }
...
_defineProperty(ConfluenceIcon, "defaultProps", DefaultProps);

export { ConfluenceIcon as default };