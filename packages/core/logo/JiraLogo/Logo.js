...
function (_Component) {
  ...
  function JiraLogo() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(JiraLogo).apply(this, arguments));
  }
...
_defineProperty(JiraLogo, "defaultProps", DefaultProps);

export { JiraLogo as default };