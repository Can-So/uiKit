...
${code`import Banner from '@findable/banner';`}

${(
  <Example
    packageName="@findable/banner"
...
We recommend using banner with [@findable/page](./page), particularly if you are
using [@findable/navigation](./navigation) alongside it.
