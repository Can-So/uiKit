...
export default evaluateInner`
  ...
  2}px, ${toggleWidthLarge -
  (toggleHeightLarge - togglePadding * 2) -
  togglePadding / 2}px ${togglePadding * 2}px;
    background-size: ${toggleHeightLarge -
      togglePadding * 2}px ${toggleHeightLarge -
  togglePadding * 2}px, ${toggleHeightLarge -
  togglePadding * 2}px ${toggleHeightLarge - togglePadding * 2}px;
  ...
  .ak-field-toggle__size-large > input:checked + label::before {
    transform: translate(${toggleWidthLarge -
      (toggleHeightLarge - togglePadding * 2) -
      togglePadding * 2}px, 0);
  }
  .ak-field-toggle__size-default > label {
    background-position: ${togglePadding * 2.5}px ${togglePadding *
  2}px, ${toggleWidthDefault -
  (toggleHeightDefault - togglePadding * 2) -
  togglePadding / 2}px ${togglePadding * 2}px;
    background-size: ${toggleHeightDefault -
      togglePadding * 2}px ${toggleHeightDefault -
  togglePadding * 2}px, ${toggleHeightDefault -
  togglePadding * 2}px ${toggleHeightDefault - togglePadding * 2}px;
  ...
  .ak-field-toggle__size-default > input:checked + label::before {
    transform: translate(${toggleWidthDefault -
      (toggleHeightDefault - togglePadding * 2) -
      togglePadding * 2}px, 0);
  }
`;
