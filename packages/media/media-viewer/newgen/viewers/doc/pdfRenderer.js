...
var PDFRenderer = /** @class */ (function (_super) {
    ...
    PDFRenderer.prototype.render = function () {
        ...
        return this.state.doc.match({
            ...
            successful: function () { return (React.createElement(PDFWrapper, { innerRef: _this.savePdfElement },
