        ...
        return (React.createElement(ToolbarContainer, null,
            React.createElement(CenterButtons, null,
                React.createElement(ButtonGroup, null,
                    ...
                    React.createElement(VerticalLine, null),
                    React.createElement(Button, { appearance: "primary", theme: "dark", onClick: onSave, autoFocus: true }, formatMessage(messages.save)),
                    React.createElement(Button, { appearance: "default", onClick: onCancel, theme: "dark" }, formatMessage(messages.cancel))))));
    };
