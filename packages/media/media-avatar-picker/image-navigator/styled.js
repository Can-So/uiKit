...
export var DragZone = styled.div(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["\n  width: 200px;\n  height: 200px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 15px;\n  position: relative;\n  border-radius: 100%;\n  transition: background-color 0.3s cubic-bezier(0.215, 0.61, 0.355, 1);\n\n  &::after {\n    content: '';\n    border: ", ";\n    border-radius: 100%;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    transition: border-color 0.3s cubic-bezier(0.19, 1, 0.22, 1);\n  }\n\n  ", ";\n"], ["\n  width: 200px;\n  height: 200px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 15px;\n  position: relative;\n  border-radius: 100%;\n  transition: background-color 0.3s cubic-bezier(0.215, 0.61, 0.355, 1);\n\n  &::after {\n    content: '';\n    border: ",
    ";\n    border-radius: 100%;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    transition: border-color 0.3s cubic-bezier(0.19, 1, 0.22, 1);\n  }\n\n  ",
    ";\n"])), function (props) {
...
export var DragZoneImage = styled.img(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["\n  width: 100px;\n"], ["\n  width: 100px;\n"])));
export var DragZoneText = styled.div(templateObject_9 || (templateObject_9 = tslib_1.__makeTemplateObject(["\n  text-align: center;\n  color: ", ";\n  ", ";\n"], ["\n  text-align: center;\n  color: ", ";\n  ",
    ";\n"])), colors.N200, function (props) {
    return props.isFullSize
        ? "width: " + (AVATAR_DIALOG_WIDTH - gridSize() * 8) + "px"
        : 'width: auto';
});
export var SelectionBlocker = styled.div(templateObject_10 || (templateObject_10 = tslib_1.__makeTemplateObject(["\n  position: fixed;\n  left: 0;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  background-color: transparent;\n  user-select: none;\n"], ["\n  position: fixed;\n  left: 0;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  background-color: transparent;\n  user-select: none;\n"])));
export var PaddedBreak = styled.p(templateObject_11 || (templateObject_11 = tslib_1.__makeTemplateObject(["\n  margin-top: 10px !important;\n  margin-bottom: 10px;\n"], ["\n  margin-top: 10px !important;\n  margin-bottom: 10px;\n"])));
