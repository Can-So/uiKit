...
export interface AvatarPickerDialogProps {
  ...
  /** This optional property is used to set the selected image so that the component opens up with it visible already.
   ...
   *  Two arguments are passed, the **file:File** which is a blob, and the crop settings which is an object containing **x:number**,**y:number**, and **size:number** values, which are all relative to the coordinates of the selected image.
