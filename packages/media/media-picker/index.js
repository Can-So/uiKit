        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [3 /*break*/, 11];
                case 1: return [4 /*yield*/, import(/* webpackChunkName:"@atlaskit-internal_media-picker-binary" */ './components/binary')];
                case 2:
                    BinaryUploaderImpl = (_b.sent()).BinaryUploaderImpl;
                    return [2 /*return*/, new BinaryUploaderImpl(context, pickerConfig)];
                case 3: return [4 /*yield*/, import(/* webpackChunkName:"@atlaskit-internal_media-picker-browser" */ './components/browser')];
                case 4:
                    BrowserImpl = (_b.sent()).BrowserImpl;
                    return [2 /*return*/, new BrowserImpl(context, pickerConfig)];
                case 5: return [4 /*yield*/, import(/* webpackChunkName:"@atlaskit-internal_media-picker-clipboard" */ './components/clipboard')];
                case 6:
                    ClipboardImpl = (_b.sent()).ClipboardImpl;
                    return [2 /*return*/, new ClipboardImpl(context, pickerConfig)];
                case 7: return [4 /*yield*/, import(/* webpackChunkName:"@atlaskit-internal_media-picker-dropzone" */ './components/dropzone')];
                case 8:
                    DropzoneImpl = (_b.sent()).DropzoneImpl;
                    return [2 /*return*/, new DropzoneImpl(context, pickerConfig)];
                case 9: return [4 /*yield*/, import(/* webpackChunkName:"@atlaskit-internal_media-picker-popup" */ './components/popup')];
                case 10:
