...
declare const _default: React.ComponentClass<Pick<GiphyViewStateProps & GiphyViewDispatchProps, never>, any> & {
    WrappedComponent: React.ComponentType<GiphyViewStateProps & GiphyViewDispatchProps>;
};
