...
declare const _default: React.ComponentClass<Pick<NavigationStateProps & NavigationDispatchProps, never>, any> & {
    WrappedComponent: React.ComponentType<NavigationStateProps & NavigationDispatchProps>;
};
