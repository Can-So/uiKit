...
import { UIAnalyticsEventHandlerSignature, ObjectType } from '@findable/analytics-next-types';
...
declare const _default: React.ComponentClass<Pick<AppProps, never> & AppOwnProps, any> & {
