...
export default {
  ...
  'fabric.media.cant_retrieve_gifs': 'Ahi, non abbiamo trovato nessuna GIF',
  'fabric.media.check_your_network': 'Controlla la connessione di rete',
  'fabric.media.try_again': 'Riprova',
  'fabric.media.no_gifs_found': 'Pronto? Sta davvero cercando me?',
  'fabric.media.no_gifs_found_suggestion':
    'Non siamo riusciti a trovare nessun risultato per “{query}”',
