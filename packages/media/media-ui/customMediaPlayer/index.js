...
import PlayIcon from '@findable/icon/glyph/vid-play';
import PauseIcon from '@findable/icon/glyph/vid-pause';
import FullScreenIconOn from '@findable/icon/glyph/vid-full-screen-on';
import FullScreenIconOff from '@findable/icon/glyph/vid-full-screen-off';
import SoundIcon from '@findable/icon/glyph/hipchat/outgoing-sound';
import HDIcon from '@findable/icon/glyph/vid-hd-circle';
...
var CustomMediaPlayer = /** @class */ (function (_super) {
    ...
    CustomMediaPlayer.prototype.render = function () {
        ...
        return (React.createElement(ThemeProvider, { theme: theme },
            React.createElement(CustomVideoWrapper, { innerRef: this.saveVideoWrapperRef },
