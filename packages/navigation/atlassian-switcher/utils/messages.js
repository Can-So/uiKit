...
var messages = defineMessages({
    ...
    people: {
        ...
        description: 'The text of a link redirecting the user to the People directory',
    },
    administration: {
...
export var SwitchToTooltipText = (React.createElement(IntlProvider, null,
    React.createElement(FormattedMessage, tslib_1.__assign({}, messages.switchToTooltip))));
