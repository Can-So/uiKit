...
export default (function (props) { return (React.createElement(CustomLinksProvider, null, function (customLinks) { return (React.createElement(CommonDataProvider, { cloudId: props.cloudId }, function (providerResults) {
    var _a = mapResultsToSwitcherProps(props.cloudId, tslib_1.__assign({ customLinks: customLinks }, providerResults), { xflow: false, enableSplitJira: props.enableSplitJira }), showManageLink = _a.showManageLink, switcherLinks = tslib_1.__rest(_a, ["showManageLink"]);
