export declare type Reason = 'OFF' | 'FALLTHROUGH' | 'RULE_MATCH' | 'TARGET_MATCH' | 'INELIGIBLE';
...
export interface FlagConstructor {
    new (flagKey: string, flag: FlagShape, trackExposure: (flagKey: string, flag: FlagShape) => void): Flag;
}
