...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@findable/modal-dialog': emptyExportPath,
      '@findable/logo': emptyExportPath,
      '@findable/avatar': emptyExportPath,
      '@findable/avatar-group': emptyExportPath,
      '@findable/profilecard': emptyExportPath,
      '@findable/select': emptyExportPath,
