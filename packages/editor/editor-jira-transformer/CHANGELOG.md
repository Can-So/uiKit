...
## 5.2.0
- [minor] [d351b2e](https://github.com/fnamazing/uiKit/commits/d351b2e):
...
## 5.1.4
- [patch] [4f0bf09](https://github.com/fnamazing/uiKit/commits/4f0bf09):
...
## 5.1.2
- [patch] [ad41550](https://github.com/fnamazing/uiKit/commits/ad41550):
...
## 3.1.6
- [patch] ED-4708: map h6 to h5 [454aab7](https://github.com/fnamazing/uiKit/commits/454aab7)
...
## 3.0.3
- [patch] Fixes a bug where the HTML for 'Done' Jira issues was not transformed properly [87a5253](https://github.com/fnamazing/uiKit/commits/87a5253)

## 3.0.1
- [patch] Fixing the up external-link attribute [e4a8e8f](https://github.com/fnamazing/uiKit/commits/e4a8e8f)
...
## 2.5.0
- [minor] Added support to editor-jira-transformer for transforming Jira emoticons to unicode emoji [7315648](https://github.com/fnamazing/uiKit/commits/7315648)
...
## 2.3.2
- [patch] Fix transformation of list with empty text child and a sublist. [ad5441f](https://github.com/fnamazing/uiKit/commits/ad5441f)

## 2.2.1
- [patch] Adding missing dependency collapse-whitespace in editor-jira-transformer. [79a668e](https://github.com/fnamazing/uiKit/commits/79a668e)
