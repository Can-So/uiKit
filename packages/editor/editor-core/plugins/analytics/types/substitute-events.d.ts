...
export declare const enum SYMBOL {
    ARROW_RIGHT = "rightArrow",
    ARROW_LEFT = "leftArrow",
    ARROW_DOUBLE = "doubleArrow"
}
export declare const enum PUNC {
    DASH = "emDash",
    ELLIPSIS = "ellipsis",
    QUOTE_SINGLE = "singleQuote",
    QUOTE_DOUBLE = "doubleQuote"
}
declare type SubstituteAEP<ActionSubjectID, Attributes> = TrackAEP<ACTION.SUBSTITUTED, ACTION_SUBJECT.TEXT, ActionSubjectID, Attributes>;
