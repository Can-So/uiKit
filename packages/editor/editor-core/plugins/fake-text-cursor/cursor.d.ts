...
export declare const addFakeTextCursor: (state: EditorState<any>, dispatch: (tr: Transaction<any>) => void) => void;
export declare const removeFakeTextCursor: (state: EditorState<any>, dispatch: (tr: Transaction<any>) => void) => void;
export declare const drawFakeTextCursor: (state: EditorState<any>) => DecorationSet<any> | null;
