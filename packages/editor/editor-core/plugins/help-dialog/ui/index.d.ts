...
export declare const getSupportedFormatting: (schema: Schema<any, any>, intl: InjectedIntl, imageEnabled?: boolean | undefined, quickInsertEnabled?: boolean | undefined) => Format[];
