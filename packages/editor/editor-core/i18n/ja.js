...
export default {
    ...
    'fabric.editor.codeblock': 'コードスニペット',
    'fabric.editor.panel': 'パネル',
    'fabric.editor.notePanel': 'ノートパネル',
    'fabric.editor.successPanel': '成功パネル',
    'fabric.editor.warningPanel': '警告パネル',
    'fabric.editor.errorPanel': 'エラーパネル',
    ...
    'fabric.editor.displayLink': 'テキスト表示',
    ...
    'fabric.editor.linkPlaceholderWithSearch': 'リンクを貼り付けまたは最近表示したページを検索',
