...
> {
   ...
   */
  private wrapped: ReactComponentConstructor = wrapComponentWithClickArea(
    ReactProsemirrorNode,
  );
  ...
  render() {
    ...
    assert(
      components[nodeTypeName],
      `Rich node with type ${nodeTypeName} is not declared`,
    );
